...
<title>18</title>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/my/css/modalResv.css">
				...
				<div class="col-xs-12 col-md-6 side-image-text">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="content" style="width : 100% ; height : 800px;">
				...
				<div class="col-md-10 text-center">
					<div class="d-flex">
						<input type="text" class="form-control m-2  mb-3" id="result_from"
							placeholder="Check in" disabled=""> <input type="text"
							class="form-control m-2  mb-3" id="result_to"
